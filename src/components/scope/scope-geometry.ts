...
// component) builds its own markup from these same numbers. Nothing here is
// ever animated directly; scope.tsx wraps these shapes in motion.* elements
// and drives their style/animate props independently — this file only
// answers "where is each shape, and what's its geometry," never "how does
// it move."
//
...
// The mouth — kept for exact fidelity with the reference implementation
// (see scope.tsx's own header comment).
