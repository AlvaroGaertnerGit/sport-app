...
// naturally returns to idle." Wire the returned function to onMouseEnter/
// onFocus; no onMouseLeave/onBlur counterpart is needed, the acknowledgment
// already self-resolves on a timer (see companion-scope.tsx's ACKNOWLEDGE_HOLD_MS).
